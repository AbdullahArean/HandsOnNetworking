...
public class DNSIterativeResolver {
    ...
    public static class DNSUDPHandler implements Runnable {
        ...
        public void run() {
            try {
                ...
                byte[] sendData = handleDNSRequest(Data);
        ...
        public static byte[] handleDNSRequest(byte[] request) throws Exception {
            ...
            int k;
            localstorage = DnsRecord.readRecordsFromFile("dns_it_resolver.txt");
...
////                    //DnsRecord.writeRecordsToFile(localstorage,"dns_it_resolver.txt" );
////                }
////                done = DNSMessageCreateSendParse.ServerDNS2(QNAME, (short) 1, FromRoot.get(0).getValue(), FromRoot.get(0).getTTL());
////                ArrayList<DnsRecord> Fromtld = DNSMessageCreateSendParse.DNSReturn(done);
////                if(!Objects.equals(Fromtld.get(0).getType(), "-1")) {
////                    return done;
////                    //localstorage.addAll(DNSMessageCreateSendParse.DNSReturn(done));
////                    //DnsRecord.writeRecordsToFile(localstorage,"dns_it_resolver.txt" );
////                }
...
//                    return done;
//                }
                done = DNSMessageCreateSendParse.ServerDNS2(QNAME, (short) 1, Fromtld.get(0).getValue(), Fromtld.get(0).getTTL());
                localstorage.addAll(DNSMessageCreateSendParse.DNSReturn(done));
                DnsRecord.writeRecordsToFile(localstorage,"dns_it_resolver.txt" );
                return  done;
            }
            ...
            //if(ipmatched.size()==0) dataOutputStream.writeShort(1);
            //else
